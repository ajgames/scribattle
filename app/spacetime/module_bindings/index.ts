...
const tablesSchema = __schema({
  ...
  drawing: __table({
    name: 'drawing',
    indexes: [
      { accessor: 'gameCode', name: 'drawing_game_code_idx_btree', algorithm: 'btree', columns: [
        'gameCode',
      ] },
      { accessor: 'id', name: 'drawing_id_idx_btree', algorithm: 'btree', columns: [
        'id',
      ] },
    ],
    constraints: [
      { name: 'drawing_id_key', constraint: 'unique', columns: ['id'] },
    ],
  }, DrawingRow),
  game: __table({
    name: 'game',
  ...
  guess: __table({
    name: 'guess',
    indexes: [
      { accessor: 'gameCode', name: 'guess_game_code_idx_btree', algorithm: 'btree', columns: [
        'gameCode',
      ] },
  ...
  liveStroke: __table({
    name: 'live_stroke',
    indexes: [
      { accessor: 'gameCode', name: 'live_stroke_game_code_idx_btree', algorithm: 'btree', columns: [
        'gameCode',
      ] },
    ],
    constraints: [
      { name: 'live_stroke_game_code_key', constraint: 'unique', columns: ['gameCode'] },
    ],
  }, LiveStrokeRow),
  player: __table({
    name: 'player',
    indexes: [
      { accessor: 'gameCode', name: 'player_game_code_idx_btree', algorithm: 'btree', columns: [
        'gameCode',
      ] },
  ...
  stroke: __table({
    name: 'stroke',
    indexes: [
      { accessor: 'gameCode', name: 'stroke_game_code_idx_btree', algorithm: 'btree', columns: [
        'gameCode',
      ] },
      { accessor: 'id', name: 'stroke_id_idx_btree', algorithm: 'btree', columns: [
        'id',
      ] },
    ],
    constraints: [
      { name: 'stroke_id_key', constraint: 'unique', columns: ['id'] },
    ],
  }, StrokeRow),
  vote: __table({
    name: 'vote',
    indexes: [
      { accessor: 'gameCode', name: 'vote_game_code_idx_btree', algorithm: 'btree', columns: [
        'gameCode',
      ] },
